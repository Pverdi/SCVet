...
public class ManterClienteController extends HttpServlet {
    ...
    private void confirmarOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        String operacao = request.getParameter("operacao");
        int codCliente = Integer.parseInt(request.getParameter("numCodCliente"));
        ...
        Cliente cliente = new Cliente(codCliente, cpf, rg, nome, numeroEndereco,
                email, complementoEndereco, telefone, cep, cidade, estado, bairro,
                logradouro);
        if (operacao.equals("Incluir")) {
            cliente.gravar();
        } else {
