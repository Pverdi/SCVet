...
public class ManterFornecedorController extends HttpServlet {
    ...
    private void confirmarOperacao(HttpServletRequest request, HttpServletResponse response)
        ...
        String operacao = request.getParameter("operacao");
        int codFornecedor = Integer.parseInt(request.getParameter("numCodFornecedor"));
        String nomeContato = request.getParameter("txtNomeContato");
        String nomeEmpresa = request.getParameter("txtNomeEmpresa");
        String cnpj = request.getParameter("numCnpj");
        int numero = Integer.parseInt(request.getParameter("numNumero"));
        String email = request.getParameter("txtEmail");
        String complemento = request.getParameter("txtComplemento");
        String telefone = request.getParameter("numTelefone1");
        ...
        Fornecedor fornecedor = new Fornecedor(codFornecedor, nomeContato, nomeEmpresa, cnpj,  numero, email, complemento,
                telefone, cep, cidade, estado, bairro, logradouro);
        if (operacao.equals("Incluir")) {
            fornecedor.gravar();
        } else {
