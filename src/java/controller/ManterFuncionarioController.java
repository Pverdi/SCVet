...
public class ManterFuncionarioController extends HttpServlet {
    ...
    private void confirmarOperacao(HttpServletRequest request, HttpServletResponse response) throws ClassNotFoundException, SQLException, ServletException, IOException {
        String operacao = request.getParameter("operacao");
        int codFuncionario = Integer.parseInt(request.getParameter("numCodFuncionario"));
        ...
        String dtAdmissao = request.getParameter("numDtAdmissao");
        String cpf = request.getParameter("numCpf");
        String rg = request.getParameter("numRg");
        String nome = request.getParameter("txtNome");
        int numeroEndereco = Integer.parseInt(request.getParameter("numNumeroEndereco"));
        String email = request.getParameter("txtEmail");
        String complementoEndereco = request.getParameter("txtComplementoEndereco");
        ...
        Funcionario funcionario = new Funcionario(codFuncionario, cargo, turno,
                especializacao, dtAdmissao, cpf, rg, nome, numeroEndereco, email,
                complementoEndereco, telefone, cep, cidade, estado, bairro,
                logradouro);
        if (operacao.equals("Incluir")) {
            funcionario.gravar();
        } else {
